...
# reviews inside the project_reviews table (shared by flask_app.py and
# admin_db.py so the admin panel can tell them apart from per-project
# reviews without needing a separate table).
SITE_REVIEW_SLUG = "__site_overall__"
